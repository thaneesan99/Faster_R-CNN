...
input_dir = r"try_1/detectron2/Sample Images"  # folder containing input images
output_dir = r"try_1/detectron2/save"  # folder to save output images
...
cfg = get_cfg()
cfg.merge_from_file(r"try_1/config.yaml")
cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.5  # set threshold for this model
cfg.MODEL.WEIGHTS = r"try_1/model_final.pth"
